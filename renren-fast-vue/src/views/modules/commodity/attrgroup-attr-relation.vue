      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-table
            ...
            <el-table-column prop="attrId" label="baseattrId"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    init (id) {
      ...
      this.visible = true
      this.$http({
        url: this.$http.adornUrl('/commodity/attrgroup/' + this.attrGroupId + '/attr/relation'),
        method: 'get',
    ...
    getDataList () {
      ...
      this.$http({
        url: this.$http.adornUrl('/commodity/attrgroup/' + this.attrGroupId + '/attr/allowrelation'),
        method: 'get',
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
