...
//    public String httpRequestParm(HttpServletRequest request) {
...
//    public String requestParamByAnnotation(@RequestParam("name")String name, @RequestParam("pwd")String pwd) {
