        ...
        <el-card class="box-card" style="width:80%;margin:20px auto">
          <el-form ref="spuBaseForm" :model="spu" label-width="120px" :rules="spuBaseInfoRules">
            ...
            <el-form-item label="选择分类" prop="catalogId">
              ...
              <el-cascader :cascadedCategoryId.sync="cascadedCategoryId" v-model="cascadedCategoryId"
...
export default {
  ...
  methods: {
    ...
    getShowSaleAttr() { //获取到销售属性
      // console.log("this.spu.catalogId分类=", this.spu.catalogId)
      //获取当前分类可以使用的销售属性
    ...
    submitSkus() { // 提交保存商品信息
      // console.log("要提交保存的商品信息 ", JSON.stringify(this.spu))
